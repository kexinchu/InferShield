...
class Scheduler(
    ...
    def __init__(
        ...
        self.policy = SchedulePolicy(
            ...
            access_budget_B=server_args.safekv_access_budget,
            creator_threshold_K=server_args.safekv_creator_threshold,
        )
        assert (
        ...
        if (
            ...
            if self.enable_hierarchical_cache:
                ...
                self.tree_cache = RadixCache(
                    ...
                    access_budget_B=server_args.safekv_access_budget,
                    creator_threshold_K=server_args.safekv_creator_threshold,
                safekv_mode=server_args.safekv_mode,
                operator_key=server_args.safekv_operator_key,
                policy_epoch=server_args.safekv_policy_epoch,
                model_id=server_args.served_model_name,
                tokenizer_version=server_args.tokenizer_path,
                experiment_autoshare=server_args.safekv_experiment_autoshare,
                )
    ...
    def get_internal_state(self, recv_req: GetInternalStateReq):
        ...
        if hasattr(self.tree_cache, "safekv_snapshot"):
            ret["safekv"] = self.tree_cache.safekv_snapshot()
