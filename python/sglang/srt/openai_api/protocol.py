...
class ChatCompletionRequest(BaseModel):
    ...
    # SafeKV control-plane authorization. The runtime validates every field and
    # MAC; merely supplying this object never grants Public visibility.
    safekv_public_authorization: Optional[Dict[str, Any]] = None
