...
from sglang.srt.principal_binding import bind_openai_user_id
...
def v1_chat_generate_request(
    ...
    for request in all_requests:
        ...
        sampling_params = {
            ...
            "safekv_public_authorization": request.safekv_public_authorization,
        }
...
async def v1_chat_completions(
    ...
    raw_request: Request,
    cache_report=False,
    effective_principal: Optional[str] = None,
):
    try:
        request_json = await raw_request.json()
    except Exception as e:
    ...
    bind_openai_user_id(all_requests[0], effective_principal)
    created = int(time.time())
    adapted_request, request = v1_chat_generate_request(
