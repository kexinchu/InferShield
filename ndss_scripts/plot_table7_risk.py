...
Style matches ndss_scripts/figures/reuse_risk_curve.pdf panel (a):
...
matches Table 7; B in {25,75} are omitted so the x-axis matches the paper figure.
    ...
    python ndss_scripts/plot_table7_risk.py

Writes ndss_scripts/figures/table7_risk_five_models.pdf
"""
...
DEFAULT_OUT = REPO / "ndss_scripts" / "figures" / "table7_risk_five_models.pdf"
