...
MODEL_CONFIGS = {
    "qwen32b": {"path": "/workspace/Models/Qwen3-32B", "tp": 2, "dp": 1, "maxlen": 32768, "mem_frac": "0.90", "cuda_devices": "0,1"},
    "qwen30b":  {"path": "/workspace/Models/Qwen3-30B-A3B-Instruct-2507", "tp": 2, "dp": 1, "maxlen": 32768, "mem_frac": "0.90", "cuda_devices": "0,1"},
    "phi4":     {"path": "/workspace/Models/Phi-4", "tp": 1, "dp": 2, "maxlen": 16384, "mem_frac": "0.85", "cuda_devices": "0,1"},
}
...
PII_DATASET = Path("/workspace/datasets/english_pii_43k.jsonl")
...
def _start_server(model: str, port: int, safekv_args: List[str], log_tag: str) -> subprocess.Popen:
    ...
    env["LD_LIBRARY_PATH"] = (
        "/workspace/.local/lib/python3.10/site-packages/nvidia/nvshmem/lib:"
