...
Edit DATA (and optionally LABELS) below, then:
    ...
    python ndss_scripts/plot_attack_defense_pies.py

Overwrites the six pies under ndss_scripts/figures/.  Pass --legend
...
FIG_DIR = REPO / "ndss_scripts" / "figures"
...
# (ndss_scripts/results/detector_window_rerun/detector_window_20260819_002302.csv).
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=FIG_DIR,
        help="Figure directory (default: ndss_scripts/figures)",
    )
    parser.add_argument(
        "--legend",
        action="store_true",
