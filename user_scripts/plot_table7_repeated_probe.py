...
Right: mean hits in k probes vs B (member vs control).
    ...
    python user_scripts/plot_table7_repeated_probe.py \
        --indir user_scripts/results/table7_repeated_probe \
        --output user_scripts/figures/table7_repeated_probe.pdf
"""
...
DEFAULT_IN = REPO / "user_scripts" / "results" / "table7_repeated_probe"
DEFAULT_OUT = REPO / "user_scripts" / "figures" / "table7_repeated_probe.pdf"
