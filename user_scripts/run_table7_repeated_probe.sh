...
#
#   ADMISSION=detector   ./user_scripts/run_table7_repeated_probe.sh phi4
#   ADMISSION=autoshare  ./user_scripts/run_table7_repeated_probe.sh phi4
#
...
"${PYTHON}" "${SCRIPT_DIR}/plot_table7_repeated_probe.py" \
  --indir "${OUT}" \
  --output "${PROJECT_DIR}/user_scripts/figures/table7_repeated_probe.pdf" || true
